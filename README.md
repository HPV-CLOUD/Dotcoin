...
# 🟣 Dotcoin AutoBot /// HPV /// V3.02 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *автоматизирует действия, которые вы обычно выполняете вручную:*<br>**—** *Получение бонуса*;<br>**—** *Улучшение бустов: `Multitap` и `Daily Attempts`*;<br>**—** *Улучшение майнинга DTC*;<br>**—** *Выполнение заданий*;<br>**—** *Улучшение майнинга DTC*;<br>**—** *Прокрут спина*; 🆕<br>**—** *Получение кол-ва доступных игр и запуск их прохождения*;<br>**—** *Просмотр рекламы и отыгрыш полученных игр*;<br>**—** *Ожидание от 10 до 13 часов*;<br>**—** *Повторение действий через 10-13 часов.<br>Все действия выполняются в случайном порядке каждый раз, когда скрипт начинает сбор. Также добавлена пустая функция просмотра привязанного кошелька и список рефералов для большей правдоподобности* |✅|
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    git clone https://github.com/HPV-CLOUD/Dotcoin
    ```
  - ```
    pip3 install HPV_TEAM_Dotcoin
    ```
- **Windows**
